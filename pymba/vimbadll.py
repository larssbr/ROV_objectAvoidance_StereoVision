...
if sys_plat == "win32":
    ...
    def find_win_dll(arch):
        ...
        #base = r'C:\Program Files\Allied Vision\Vimba_2.0\VimbaC\Bin\Win64\VimbaC.dll'
    ...
    if '64' in platform.architecture()[0]:
        vimbaC_path = r'C:\Program Files\Allied Vision\Vimba_2.0\VimbaC\Bin\Win64\VimbaC.dll' #find_win_dll(64)
    else:
        vimbaC_path = r'C:\Program Files\Allied Vision\Vimba_2.0\VimbaC\Bin\Win64\VimbaC.dll' #find_win_dll(32)
    dll_loader = windll
else:
